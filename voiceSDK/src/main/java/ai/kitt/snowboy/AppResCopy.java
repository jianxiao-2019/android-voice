...
public class AppResCopy {
    private final static String TAG = "AppResCopy";
    ...
    public static void copyResFromAssetsToSD(Context context, String assetsSrcDir, String sdcardDstDir) {
        copyFilesFromAssets(context, assetsSrcDir, sdcardDstDir, true);
    }
