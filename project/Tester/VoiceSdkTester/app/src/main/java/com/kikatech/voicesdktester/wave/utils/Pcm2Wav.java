package com.kikatech.voicesdktester.wave.utils;
...
public class Pcm2Wav
{
    ...
    public void convertAudioFiles(String src, String target) throws Exception
    {
        ...
        com.kikatech.voicesdktester.wave.utils.WaveHeader header = new com.kikatech.voicesdktester.wave.utils.WaveHeader();
