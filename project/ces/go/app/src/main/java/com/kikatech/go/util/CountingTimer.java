...
public class CountingTimer implements Runnable
{
    ...
    private void tick()
    {
		...
		BackgroundThread.getHandler().postDelayed( this, countDownInterval );
    }
    ...
    public void stop()
    {
        if( mCountingListener != null ) mCountingListener.onStop( mCountedTime );
        reset();
    }
