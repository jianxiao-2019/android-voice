...
public class StageErrorServerConnection extends StageError {

    public StageErrorServerConnection(@NonNull SceneBase scene, ISceneFeedback feedback) {
    ...
    protected void action() {
        String[] uiAndTtsText = SceneUtil.getErrorServerConnection(mSceneBase.getContext());
