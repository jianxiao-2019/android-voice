...
public class AppConstants {
    ...
    public static final int SMALL_ICON_WHATSAPP = R.drawable.st_im_whatsapp_smal;
    public static final int SMALL_ICON_SKYPE = R.drawable.st_im_skype_smal;
    public static final int SMALL_ICON_KIK = R.drawable.st_im_kik_smal;
    public static final int SMALL_ICON_KAKAOTALK = R.drawable.st_im_kakaotalk_smal;
    public static final int SMALL_ICON_VIBER = R.drawable.st_im_viber_smal;
    public static final int SMALL_ICON_SLACK = R.drawable.st_im_slack_smal;
    public static final int SMALL_ICON_TELEGRAM = R.drawable.st_im_telegram_smal;
    public static final int SMALL_ICON_HANGOUTS = R.drawable.st_im_hangout_smal;
    public static final int SMALL_ICON_ALLO = R.drawable.st_im_google_allo_smal;
