...
public class UsbActivity extends AppCompatActivity
{
	...
	protected void onCreate( Bundle savedInstanceState )
	{
		...
		btnStart.setOnClickListener( new View.OnClickListener() {
			...
			{
				UsbAudioService.processStartAudioTransfer( UsbActivity.this, new IUsbAudioTransferListener() {
					@Override
		...
		btnStop.setOnClickListener( new View.OnClickListener() {
			...
			public void onClick( View v )
			{
				UsbAudioService.processStopAudioTransfer( UsbActivity.this );
			}
		} );

		UsbAudioService.processStart( UsbActivity.this, new IUsbStatusListener()
		{
			@Override
