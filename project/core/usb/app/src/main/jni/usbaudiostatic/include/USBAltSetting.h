...
public:
     ...
     */
	virtual bool init(int& o_stackTrace);
    ...
    std::string getAudioInterfaceSubClassString() const;
    ...
    virtual void findAndAddInterruptEndPoints(bool i_in,
...
protected:
    ...
    virtual bool initControlsAndUnits(int& o_stackTrace) = 0;
