...
public:
    ...
    static std::string transferTypeToString(TransferType i_type);
    static std::string syncTypeToString(SyncType i_type);
    static std::string usageTypeToString(UsageType i_type);
