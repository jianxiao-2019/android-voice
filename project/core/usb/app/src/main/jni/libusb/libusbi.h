...
struct usbi_os_backend {
    ...
    int (*open_existing)(struct libusb_device_handle *handle, int fd);
    struct libusb_device* (*get_device_by_name)(struct libusb_context *ctx, const char *dev_node, int i_fd, unsigned char* i_rawDescriptors, int i_rawDescriptionsLength);
    ...
    void (*close_existing)(struct libusb_device_handle *handle, int fd);
