...
int LIBUSB_CALL libusb_init(libusb_context **ctx, int i_enumerateDevices);
...
int LIBUSB_CALL libusb_open_existing(libusb_device *dev, libusb_device_handle **handle, int fd);
void LIBUSB_CALL libusb_close_existing(libusb_device_handle *dev_handle, int fd);
